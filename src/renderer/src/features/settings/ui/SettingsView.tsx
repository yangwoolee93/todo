 ...
 * 설정 뷰 — 테마 + 데이터 백업
 */
export function SettingsView({ themeMode, onChangeTheme, onRefresh }: SettingsViewProps) {
  return (
    <div className="flex flex-col gap-4">
      <section className="card">
        ...
        <ThemeSelector mode={themeMode} onChange={onChangeTheme} />
      </section>
      ...
      <section className="card">
        ...
        <BackupPanel onRefresh={onRefresh} />
      </section>
    </div>
  )
}
